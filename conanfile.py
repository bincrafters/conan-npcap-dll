...
class NpcapDllConan(ConanFile):
    ...
    def build(self):
        ...
        print("does vcvarsall.bat exist?  " + str(os.path.isfile(r'C:\Program Files (x86)\Microsoft Visual Studio\2017\Community\Common7\Tools\../../VC/Auxiliary/Build/vcvarsall.bat')))
        #self.run(vcvars)
